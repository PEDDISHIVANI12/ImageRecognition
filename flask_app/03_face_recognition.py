...
#img.set(3, 640) # set video widht
#img.set(4, 480) # set video height
...
while True:
    ...
    #image_scaled_2 = cv2.resize(img, None, fx=2, fy=2, interpolation=cv2.INTER_CUBIC)
    #cv2.imshow(cv2.cvtColor(image_scaled_2, cv2.COLOR_BGR2RGB)) 
